...
class MediaPropertyStore {
  ...
  */
  ...
  GetMediaPropertyAttributes({mediaPropertySlugOrId=null}) {
  ...
  MediaProperty({mediaPropertySlugOrId}) {
    ...
    let property =  mediaPropertyStore.mediaProperties[mediaPropertySlugOrId];
    if (!property) {
      return;
    }

    return {...property.metadata?.public?.asset_metadata, metadata:property.metadata?.public?.asset_metadata?.info};
  }
  ...
  MediaPropertySection({mediaPropertySlugOrId, sectionSlugOrId, mediaListSlugOrId}) {
    ...
    if(!mediaListSlugOrId) {
      ...
      const mediaList = this.MediaPropertyMediaItem({mediaItemSlugOrId: mediaListId});
  ...
  MediaPropertyMediaItem({mediaItemSlugOrId}) {
    ...
    return mediaPropertyStore.GetMediaItem({mediaItemId: mediaItemSlugOrId});
  }

  ResolveSectionItem({mediaPropertyId, sectionId, sectionItem}) {
    ...
    */  
    return mediaPropertyStore.GetResolvedSectionItem({mediaPropertyId, sectionId, sectionItemId: sectionItem.id, sectionItem});
  }
      ...
      content = (        
        ...
        .map(mediaItem =>
          this.ResolveSectionItem({
            mediaPropertyId: mediaPropertySlugOrId,
      ...
      content = (
        content.map(sectionItem => {
          if(!sectionItem.expand || sectionItem.type !== "media") {
            return this.ResolveSectionItem({mediaPropertyId: mediaPropertySlugOrId, sectionId: section.id, sectionItem});
          }
