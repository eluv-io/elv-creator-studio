...
export const Carousel = observer(({
  ...
  return (
    <MantineCarousel
      ...
      slideSize="10%" align="start" slideGap="md"
      previousControlIcon={<ImageIcon label="Previous Page" icon={LeftArrow} />}
      nextControlIcon={<ImageIcon label="Next Page" icon={RightArrow} />}
...
export const CarouselOld = observer(({
  content,
  swiperOptions={},
  UpdateActiveIndex,
  UpdateActiveSlideIndex,
  ...
  let slidesPerView= 3;
  try {
    //slidesPerView = swiper?.slidesPerViewDynamic() - 1 || 1;
    slidesPerView = slidesPerPage({imageDimensions,swiper});
