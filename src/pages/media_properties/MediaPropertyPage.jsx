  ...
  return (
    ...
    >
      ...
      <Group>
        ...
        {
          info.page_ids.purchase_gate !== pageId ?
            <Button
              onClick={async () => {
                await Confirm({
                  title: LocalizeString(l10n.action_labels.set_purchase_gate_page, {label: page.label}),
                  text: LocalizeString(l10n.action_labels.set_purchase_gate_page_confirm, {label: page.label}),
                  onConfirm: () => mediaPropertyStore.SetPropertyPageSlug({
                    mediaPropertyId,
                    pageId,
                    slug: "purchase_gate",
                    label: l10n.action_labels.set_purchase_gate_page
                  })
                });
              }}
            >
              { l10n.action_labels.set_purchase_gate_page }
            </Button> :
            <Button
              variant="outline"
              onClick={async () => {
                await Confirm({
                  title: LocalizeString(l10n.action_labels.clear_purchase_gate_page, {label: page.label}),
                  text: LocalizeString(l10n.action_labels.clear_purchase_gate_page_confirm, {label: page.label}),
                  onConfirm: () => mediaPropertyStore.SetPropertyPageSlug({
                    mediaPropertyId,
                    pageId,
                    slug: "purchase_gate",
                    label: l10n.action_labels.clear_purchase_gate_page,
                    clear: true
                  })
                });
              }}
            >
              { l10n.action_labels.clear_purchase_gate_page }
            </Button>
        }
      </Group>
      ...
      {
        info.page_ids.purchase_gate !== pageId ? null :
          <Text italic mt="xs" fz="xs">This is the purchase page for this property</Text>
      }
